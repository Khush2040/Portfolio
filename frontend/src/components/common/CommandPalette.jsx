        ...
        <AnimatePresence>
            ...
            {isOpen && (
                <motion.div
                    ...
                    className="fixed top-[20%] left-1/2 -translate-x-1/2 w-[90%] max-w-lg bg-[#0a0a0a] border border-gray-700/50 rounded-2xl shadow-2xl z-[101] overflow-hidden flex flex-col"
                >
                        ...
                        {filteredActions.length > 0 ? (
                            filteredActions.map((action, index) => (
                                <motion.button
                                    ...
                                    className="w-full flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/5 text-gray-300 hover:text-white transition-all text-left group"
                                >
