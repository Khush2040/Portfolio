                ...
                <>
                    ...
                    <motion.div
                        ...
                        className={cn(
                            ...
                            theme === 'dark' ? "bg-[#0a0a0a]/90 border-r border-white/10" : "bg-white/90 border-r border-black/10"
                        )}
                    >
                        {/* Header */}
                        <div className="flex items-center justify-between mb-8">
                            <div className="flex items-center gap-3">
                                <img src="/avatar_cartoon.png" alt="Khushi Avatar" className="w-10 h-10 rounded-full border-2 border-purple-500/50 object-cover" />
                            ...
                            <button
                                ...
                                className={cn(
                                    ...
                                    theme === 'dark' ? "hover:bg-white/10 text-gray-400 hover:text-white" : "hover:bg-black/10 text-gray-600 hover:text-black"
                                )}
                            >
                                <X size={20} />
                            </button>
                                    ...
                                    <Link
                                        ...
                                        className={cn(
                                            ...
                                            isActive
                                                ...
                                                : (theme === 'dark' ? "text-gray-400 hover:bg-white/5 hover:text-white" : "text-gray-600 hover:bg-black/5 hover:text-black")
                                        )}
                                    >
                        ...
                        <div className="flex flex-col gap-2 mt-auto">
                            ...
                            <div className={cn(
                                ...
                                <div className="flex items-center justify-between">
                                    <div className={cn("flex items-center gap-3 font-medium cursor-default", theme === 'dark' ? "text-gray-200" : "text-gray-800")}>
                                        <Settings size={16} />
                                ...
                                <div className="flex items-center justify-between">
                                    <div className={cn("flex items-center gap-3 text-sm font-medium", theme === 'dark' ? "text-gray-400" : "text-gray-600")}>
                                        <Sparkles size={15} />
                        ...
                        <div className={cn(
                            ...
                            <a href="https://github.com/Khush2040" target="_blank" rel="noreferrer" className={cn(
                            ...
                            <a href="mailto:hello@example.com" className={cn(
                                "p-2 transition-colors duration-300",
                                theme === 'dark' ? "text-gray-400 hover:text-white" : "text-gray-500 hover:text-black"
                            )}>
                                <Mail size={20} />
