    ...
    return (
        <footer className="relative bg-[#050505] pt-32 pb-10 overflow-hidden border-t border-white/5">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 w-full pt-12 border-t border-white/10 z-10 relative">
                    ...
                    <div className="flex flex-col gap-4 items-center">
                        ...
                        <div className="flex flex-col gap-2 items-center">
                            ...
                            <Link to="/certifications" className="text-gray-400 hover:text-white transition-colors">Certifications</Link>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-4 items-center md:items-end w-full">
                        ...
                        <div className="flex gap-4">
                            <MagneticButton href="https://github.com/Khush2040">
                                <div className="p-3 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 hover:border-blue-500/50 hover:text-blue-400 transition-all shadow-lg hover:shadow-[0_0_15px_rgba(59,130,246,0.5)]">
                                    <Github size={20} />
                                </div>
                            </MagneticButton>
                            ...
                            <MagneticButton href="https://medium.com/@khushypro">
                                <div className="flex items-center justify-center w-12 h-12 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 hover:border-blue-500/50 hover:text-blue-400 transition-all shadow-lg hover:shadow-[0_0_15px_rgba(59,130,246,0.5)]">
                                    <span className="font-bold text-lg leading-none">M</span>
                                </div>
                            </MagneticButton>
                            <MagneticButton href="mailto:khushboo@example.com">
                                <div className="p-3 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 hover:border-blue-500/50 hover:text-blue-400 transition-all shadow-lg hover:shadow-[0_0_15px_rgba(59,130,246,0.5)]">
                                    <Mail size={20} />
                                </div>
                            </MagneticButton>
                ...
                <div className="w-full text-center pt-8 mt-12 border-t border-white/10 text-gray-500 text-sm flex flex-col md:flex-row justify-between items-center gap-4 z-10 relative">
                    <p>© {new Date().getFullYear()} Khushboo. All rights reserved.</p>
                </div>
            </div>
