            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className={`fixed z-[60] bg-[#0a0a0a]/90 backdrop-blur-xl border border-gray-700/50 shadow-2xl overflow-hidden flex flex-col font-mono text-sm ${isMaximized
                        ...
                        <div className="flex-1 p-4 overflow-y-auto text-gray-300" onClick={() => inputRef.current?.focus()}>
                            ...
                            <div className="flex items-center gap-2 mt-2">
                                ...
                                <input
                                    ...
                                    className="flex-1 bg-transparent outline-none border-none text-gray-200 caret-white"
                                    spellCheck="false"
                                    autoComplete="off"
                                />
                            </div>
