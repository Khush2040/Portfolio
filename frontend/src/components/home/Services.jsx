                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 justify-center">
                    {services.map((service, index) => (
                        <motion.div
                            ...
                            whileHover={{ y: -5 }}
                            className={`p-8 rounded-3xl glass border border-white/5 transition-all duration-300 ${service.border} relative overflow-hidden`}
                        >
                            ...
                            <div className="relative z-10">
                                <div className="mb-6 p-4 rounded-full bg-white/5 inline-block backdrop-blur-md border border-white/10">
                                    {service.icon}
                                </div>
