...
const awardsData = [
    { title: "NSTSE 2022", rank: "AIR 9", icon: Trophy, color: "text-amber-500 dark:text-amber-400" },
    { title: "NSTSE 2021", rank: "State Rank 19", icon: Award, color: "text-amber-500 dark:text-amber-400" },
    { title: "International Commerce Olympiad 2021", rank: "School Rank 1", icon: Medal, color: "text-yellow-500 dark:text-yellow-400" },
    { title: "International English Olympiad 2021", rank: "School Rank 1", icon: Medal, color: "text-yellow-500 dark:text-yellow-400" },
    { title: "International Mathematics Olympiad 2021", rank: "School Rank 1", icon: Medal, color: "text-yellow-500 dark:text-yellow-400" },
    { title: "National Science Olympiad 2021", rank: "School Rank 1", icon: Medal, color: "text-yellow-500 dark:text-yellow-400" },
    { title: "International General Knowledge Olympiad 2020", rank: "School Rank 2", icon: Star, color: "text-slate-500 dark:text-slate-300" },
    { title: "National Science Olympiad 2020", rank: "School Rank 3", icon: Medal, color: "text-orange-500 dark:text-orange-400" },
    { title: "International English Olympiad 2019", rank: "School Rank 3", icon: Medal, color: "text-orange-500 dark:text-orange-400" },
    { title: "International English Olympiad 2020", rank: "School Rank 4", icon: Award, color: "text-blue-500 dark:text-blue-400" },
    { title: "International Mathematics Olympiad 2020", rank: "School Rank 5", icon: Award, color: "text-blue-500 dark:text-blue-400" }
];
...
const MuseumPlaque = ({ award, index, isHovered, onHover, onLeave }) => {
    ...
    return (
        <motion.div
            ...
            className="relative flex items-center justify-between p-4 md:p-6 rounded-[20px] md:rounded-[24px] border border-gray-200/50 dark:border-white/10 bg-white/40 dark:bg-black/20 backdrop-blur-md shadow-sm transition-all duration-500 cursor-none"
        >
            ...
            <div className="relative flex items-center gap-4 md:gap-6 z-10 w-full">
                <div className={`relative flex shrink-0 items-center justify-center h-12 w-12 md:h-16 md:w-16 rounded-full border border-gray-200 dark:border-white/10 shadow-inner ${award.color} bg-gray-50 dark:bg-white/5`}>
...
const Awards = () => {
    ...
    return (
        <section className="py-24 relative overflow-hidden flex flex-col items-center justify-center font-sans tracking-tight border-t border-gray-100 dark:border-white/5">
            ...
            <div className="w-full relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <p className="text-gray-600 dark:text-gray-400 max-w-md text-lg leading-relaxed text-left lg:text-right">
