...
const languages = [
    ...
    { name: "French", proficiency: "Elementary proficiency", level: 45, color: "bg-pink-500" }
];
                ...
                <div className="space-y-8">
                    {languages.map((lang, index) => (
                        <motion.div
                            ...
                            className="bg-gray-50 dark:bg-white/[0.02] p-6 rounded-2xl border border-gray-100 dark:border-white/5"
                        >
                            <div className="flex justify-between items-center mb-4">
                                <div>
                                    <h4 className="text-xl font-bold text-gray-900 dark:text-white">{lang.name}</h4>
                                    <p className="text-sm text-gray-500 dark:text-gray-400 font-medium tracking-wide mt-1">{lang.proficiency}</p>
                                </div>
                                <span className="text-2xl font-black text-gray-300 dark:text-gray-700">{lang.level}%</span>
                            </div>
