...
const PublicationCard = ({ pub, index }) => {
    return (
        <motion.a
            ...
            className="group relative flex flex-col justify-between p-6 md:p-8 rounded-[24px] border border-gray-200/50 dark:border-white/10 bg-white/40 dark:bg-black/20 backdrop-blur-md shadow-sm hover:shadow-xl transition-all duration-500 h-full overflow-hidden"
        >
            ...
            <div className="relative z-10 flex flex-col h-full">
                <div className="flex justify-between items-start mb-6 w-full">
                    <div className={`flex shrink-0 items-center justify-center h-14 w-14 rounded-2xl border border-gray-200 dark:border-white/10 shadow-inner ${pub.color} bg-gray-50 dark:bg-white/5 group-hover:scale-110 transition-transform duration-500`}>
                        <pub.icon size={28} strokeWidth={1.5} />
                    </div>
                    <div className="p-2 rounded-full bg-gray-100 dark:bg-white/5 text-gray-400 group-hover:text-blue-500 group-hover:bg-blue-50 dark:group-hover:bg-blue-500/20 transition-all duration-300">
...
const Publications = () => {
    return (
        <section className="py-24 relative overflow-hidden flex flex-col items-center justify-center font-sans tracking-tight border-t border-gray-100 dark:border-white/5 bg-gray-50/50 dark:bg-transparent">
            {/* Ambient Lighting */}
