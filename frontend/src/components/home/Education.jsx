        ...
        <section className="py-24 relative overflow-hidden flex flex-col items-center">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
                ...
                >
                    ...
                    <p className="text-gray-400 max-w-xl mx-auto text-lg">Tracing the path from foundational learning to cutting-edge development.</p>
                </motion.div>
                    ...
                    <div className="glass p-8 md:p-12 rounded-3xl border border-blue-500/20 overflow-hidden group hover:border-blue-500/40 transition-colors">
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-12 relative z-10">
                            ...
                            <div className="flex-1 text-center md:text-left">
                                <div className="w-16 h-16 bg-[#020617] border border-white/10 rounded-2xl flex items-center justify-center mb-6 shadow-lg mx-auto md:mx-0">
                                ...
                                <p className="text-gray-400 mb-8 leading-relaxed max-w-lg mx-auto md:mx-0 text-lg">
                            ...
                            <div className="flex-1 w-full space-y-4">
                                {[
                                    { title: "How Mistakes Become Lessons: Learning the Hard Way", tag: "Personal Growth" },
                                    { title: "A Simple Guide to the OpenxAI Ecosystem", tag: "Tech & AI" },
                                    { title: "Cognitive Load: The Hidden Reason College Students Procrastinate", tag: "College Life" }
                                ].map((blog, idx) => (
                                    <a
                                        key={idx}
                                        href="https://medium.com/@khushypro"
                                        target="_blank"
                                        rel="noreferrer"
                                        className="block glass p-6 rounded-2xl border border-white/5 hover:border-blue-500/30 hover:bg-blue-500/5 transition-all w-full text-left cursor-pointer group/card shadow-lg"
                                    >
                                        ...
                                        <h4 className="font-semibold text-gray-200 group-hover/card:text-white transition-colors leading-snug">
                                            {blog.title}
                                        </h4>
                                    </a>
                                ))}
