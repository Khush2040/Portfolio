...
const skillsRow1 = [
    ...
    "MySQL", "SQL Server", "FastAPI", "Arduino", "Swing GUI",
    "Apache Netbeans IDE", "Apache ANT", "Git", "GitHub", "Canva"
];
...
const skillsRow2 = [
    ...
    "Jupyter Notebook", "Power BI", "Microsoft Excel (Advanced)", "MS-Office",
    "End-to-End Data Analysis", "Dataset Preparation & Quality Validation",
    "Predictive Analytics using Supervised ML Models",
    "Business-Oriented Data Visualization",
    "Performance Evaluation & Insight Communication"
];
// Duplicate for seamless loop
            ...
            <div className="relative w-full flex overflow-x-hidden mb-6 group">
                ...
                >
                    {duplicatedRow1.map((skill, index) => (
                        <div
                            key={index}
                            className="px-8 py-4 rounded-2xl glass border border-white/5 shadow-lg bg-white/5 hover:bg-white/10 hover:border-blue-500/40 hover:shadow-[0_0_20px_rgba(59,130,246,0.3)] transition-all duration-300 flex items-center justify-center cursor-default"
                        >
                ...
                {/* Gradient Masks */}
                <div className="absolute top-0 bottom-0 left-0 w-32 bg-gradient-to-r from-[#0f1016] to-transparent z-10 pointer-events-none"></div>
                <div className="absolute top-0 bottom-0 right-0 w-32 bg-gradient-to-l from-[#0f1016] to-transparent z-10 pointer-events-none"></div>
            </div>
            ...
            <div className="relative w-full flex overflow-x-hidden group">
                ...
                >
                    {duplicatedRow2.map((skill, index) => (
                        <div
                            key={index}
                            className="px-8 py-4 rounded-2xl glass border border-white/5 shadow-lg bg-white/5 hover:bg-white/10 hover:border-purple-500/40 hover:shadow-[0_0_20px_rgba(168,85,247,0.3)] transition-all duration-300 flex items-center justify-center cursor-default"
                        >
                            <span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-200 to-white">
                                {skill}
                            </span>
