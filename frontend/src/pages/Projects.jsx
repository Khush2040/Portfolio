...
const Projects = () => {
    const projects = [
        {
            ...
            description: 'AI-Powered Software Project Planning & Architecture Platform helping users transform raw software ideas into detailed software plans before writing code.',
            tags: ['SaaS', 'AI', 'Architecture'],
            url: 'https://github.com/Khush2040',
            color: 'from-blue-500/20 to-indigo-500/20',
            image: '/projects/projectforge_ai.png'
        },
        {
            title: 'Spotify Listening Behavior Dashboard | Tableau',
            description: 'An interactive Tableau project that analyzes Spotify streaming history to uncover listening patterns, artist preferences, and consumption trends.',
            tags: ['Tableau', 'Data Viz', 'Analytics'],
            url: 'https://github.com/Khush2040',
            color: 'from-green-500/20 to-emerald-500/20',
            image: '/projects/spotify_dashboard.png'
        },
        {
            title: 'AlphaBoard AI',
            description: 'A Multi-Agent AI Investment Research Platform adopting a committee-based approach to analyze companies and generate financial recommendations.',
            tags: ['AI', 'Multi-Agent', 'Finance'],
            url: 'https://github.com/Khush2040',
            color: 'from-purple-500/20 to-pink-500/20',
            image: '/projects/alphaboard_ai.png'
        },
        {
            title: 'FileShare Pro',
    ...
    return (
        <PageWrapper className="min-h-screen py-32 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full bg-[#050505] overflow-hidden">
            ...
            >
                ...
                <p className="text-xl text-gray-400 leading-relaxed font-light max-w-2xl mx-auto md:mx-0">
            ...
            >
                {projects.map((item, index) => (
                    <motion.div
                        ...
                        className="group relative flex flex-col h-full rounded-3xl overflow-hidden glass border border-white/5 hover:border-white/20 transition-all duration-500 hover:-translate-y-2 bg-gradient-to-b from-white/[0.03] to-transparent"
                    >
                        {/* Glow Effect */}
                        ...
                        <div className="relative p-8 pt-6 flex flex-col flex-grow z-10 bg-gradient-to-b from-transparent to-black/20">
                            ...
                            <div className="flex gap-2 flex-wrap mb-8 mt-auto">
                                {item.tags.map(tag => (
                                    <span key={tag} className="text-xs px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-gray-300 font-medium">
                                        {tag}
                                    </span>
                                ))}
                            </div>
            ...
            >
                <MagneticButton href="https://github.com/Khush2040">
                    <div className="inline-flex items-center justify-center gap-3 px-8 py-4 rounded-full bg-white/5 border border-white/10 text-white font-bold hover:bg-white/10 hover:border-white/20 transition-all duration-300">
