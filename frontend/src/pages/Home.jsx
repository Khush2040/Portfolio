                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10 relative">
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        ...
                        <motion.div className="text-left font-sans">
                            ...
                            <p className="reveal-fade text-lg sm:text-xl text-gray-700 dark:text-gray-300 max-w-xl mb-6 leading-relaxed font-light">
                                <span className="text-gray-900 dark:text-white font-semibold border-b border-purple-500/50">Python | SQL | Informatica (ETL) | MERN Stack | AI/ML | <br /> Cloud & DevOps</span>
                                <br /><br />
                                Building efficient data pipelines, extracting meaningful insights, and developing robust full-stack applications.
                            </p>
