    ...
    return (
        <PageWrapper>
            <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-screen">
                ...
                >
                    <div className="w-20 h-20 mx-auto bg-[#020617] border border-white/10 rounded-2xl flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(255,255,255,0.05)]">
                        <img
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-16">
                    {blogPosts.map((post, index) => (
                        <motion.a
                            ...
                            className="glass p-8 rounded-3xl border border-white/5 hover:border-purple-500/30 hover:bg-white/5 transition-all group flex flex-col h-full shadow-lg relative overflow-hidden"
                        >
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-gray-300 mb-8 max-w-xl mx-auto text-lg hover:text-white transition-colors">
