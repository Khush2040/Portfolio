...
const Contact = () => {
    ...
    return (
        <PageWrapper className="min-h-screen py-32 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full bg-[#050505] overflow-hidden flex flex-col justify-center">
            ...
            >
                ...
                <h3 className="text-5xl sm:text-6xl lg:text-7xl font-black leading-[1.1] mb-6 tracking-tight text-white">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 max-w-5xl mx-auto w-full">
                ...
                >
                    <div className="glass p-8 sm:p-10 rounded-3xl border border-white/5 bg-gradient-to-b from-white/[0.03] to-transparent shadow-2xl relative">
                        {status.success && (
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="group relative">
                                <input
                                    type="text"
                                    className="w-full px-5 py-4 rounded-2xl bg-white/5 border border-white/10 text-white placeholder-transparent focus:border-purple-500 focus:outline-none focus:ring-1 focus:ring-purple-500/50 transition-all peer"
                                    placeholder="Name"
                                    id="name"
                                    value={formData.name}
                            ...
                            <div className="group relative">
                                <textarea
                                    rows={5}
                                    className="w-full px-5 py-4 rounded-2xl bg-white/5 border border-white/10 text-white placeholder-transparent focus:border-purple-500 focus:outline-none focus:ring-1 focus:ring-purple-500/50 transition-all peer resize-none"
                                    placeholder="Message"
                                    id="message"
                                    ...
                                    required
                                ></textarea>
                                <label htmlFor="message" className="absolute left-5 top-4 text-gray-500 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:top-4 peer-focus:-top-3 peer-focus:text-xs peer-focus:text-purple-400 peer-valid:-top-3 peer-valid:text-xs bg-[#0a0a0a] px-1 rounded">
                                    Project Details
                                </label>
                            </div>
                            ...
                            <button
                                ...
                                className={`w-full relative overflow-hidden group py-4 px-6 rounded-2xl font-bold text-lg transition-all ${status.loading ? 'bg-white/10 text-gray-400 cursor-not-allowed' : 'bg-white text-black hover:scale-[1.02]'}`}
                            >
                ...
                >
                    <div>
                        <h4 className="text-2xl font-bold text-white mb-4">Direct Sync</h4>
                    ...
                    <div className="space-y-4">
                        <MagneticButton href="mailto:khushi792005@gmail.com">
                            <div className="flex items-center gap-4 p-4 rounded-2xl glass border border-white/5 hover:bg-white/5 transition-colors group cursor-pointer w-full">
                                <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center group-hover:scale-110 transition-transform">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-300"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                                </div>
                                <div>
                                    <p className="text-sm text-gray-500 font-medium">Direct Email</p>
                                    <p className="text-white font-bold group-hover:text-purple-400 transition-colors">khushi792005@gmail.com</p>
                                </div>
                            </div>
                        </MagneticButton>
                        ...
                        <MagneticButton href="https://medium.com/@khushypro">
                            <div className="flex items-center gap-4 p-4 rounded-2xl glass border border-white/5 hover:bg-white/5 transition-colors group cursor-pointer w-full mt-4 block">
                                ...
                                <div>
                                    ...
                                    <p className="text-white font-bold group-hover:text-purple-400 transition-colors">medium.com/@khushypro</p>
                                </div>
                            </div>
                        </MagneticButton>
                    </div>
